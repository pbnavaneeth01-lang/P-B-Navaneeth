  ...
  >
    ...
    <div className="flex items-start justify-between mb-8 relative z-10">
      ...
      <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-4 group-hover:translate-x-0">
        <button 
          onClick={onEdit} 
          className="p-2.5 text-slate-500 hover:text-white hover:bg-slate-800 rounded-xl border border-transparent hover:border-slate-700 transition-all"
        ...
        <button 
          onClick={onDelete} 
          className="p-2.5 text-slate-500 hover:text-rose-400 hover:bg-rose-400/10 rounded-xl border border-transparent hover:border-rose-500/20 transition-all"
    ...
    <div className="relative z-10 flex-1">
      <p className="text-[10px] font-mono font-black text-blue-500 uppercase tracking-[0.2em] mb-2">Assessment Paper</p>
      ...
      <div className="flex items-center gap-4 text-slate-500 font-mono text-[10px] uppercase tracking-widest">
        <div className="flex items-center gap-2">
          ...
          <span>{exam.studentList?.length || 0} Nodes</span>
        </div>
